...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/font-awesome-4.2.0/css/font-awesome.min.css' />" />

    <!-- text fonts -->
    <link rel="stylesheet" href="<c:url value='/css/fonts/fonts.googleapis.com.css' />" />
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="red">IntelliPipeline</span>
                                    ...
                                    <form>
                                        <fieldset>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <button type="button" class="width-35 pull-right btn btn-sm btn-primary" onclick="loginPage.login()">
